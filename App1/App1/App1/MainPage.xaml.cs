...
namespace App1
{
    ...
    public partial class MainPage : ContentPage
    {
        ...
        public MainPage()
        {
            ...
            question19.IsVisible = false;
            question20.IsVisible = false;
            question21.IsVisible = false;
            question22.IsVisible = false;
            question23.IsVisible = false;
            question24.IsVisible = false;
            question25.IsVisible = false;
        ...
        #endregion
        #region Question 19
        private void KURTQ19(object sender, EventArgs e)
        {
            question19.IsVisible = false;
            question20.IsVisible = true;
            score = score + 1;
            DisplayAlert("Information", "Good answer !", "Ok");
            scorelabelingame.Text = "Here is your score : " + score.ToString() + " /25";
        }
        private void IMCSXQ19(object sender, EventArgs e)
        {
            question19.IsVisible = false;
            question20.IsVisible = true;
            DisplayAlert("Information", "Incorrect answer !", "Ok");
        ...
        private void D3CHQ19(object sender, EventArgs e)
        {
            question19.IsVisible = false;
            question20.IsVisible = true;
            DisplayAlert("Information", "Incorrect answer !", "Ok");
        ...
        private void SHARKQ19(object sender, EventArgs e)
        {
            question19.IsVisible = false;
            question20.IsVisible = true;
            DisplayAlert("Information", "Incorrect answer !", "Ok");
        ...
        #endregion
        #region Question 22
        private void NOVQ22(object sender, EventArgs e)
        {
            question22.IsVisible = false;
            question23.IsVisible = true;
            DisplayAlert("Information", "Incorrect answer !", "Ok");
            scorelabelingame.Text = "Here is your score : " + score.ToString() + " /25";
        }
        private void DECQ22(object sender, EventArgs e)
        {
            question22.IsVisible = false;
            question23.IsVisible = true;
            score = score + 1;
        ...
        private void JANQ22(object sender, EventArgs e)
        {
            question22.IsVisible = false;
            question23.IsVisible = true;
            DisplayAlert("Information", "Incorrect answer !", "Ok");
        ...
        private void FEBQ22(object sender, EventArgs e)
        {
            question22.IsVisible = false;
            question23.IsVisible = true;
            DisplayAlert("Information", "Incorrect answer !", "Ok");
        ...
        #endregion
        #region Question 23
        private void OCT15Q23(object sender, EventArgs e)
        {
            question23.IsVisible = false;
            question24.IsVisible = true;
            DisplayAlert("Information", "Incorrect answer !", "Ok");
            scorelabelingame.Text = "Here is your score : " + score.ToString() + " /25";
        }
        private void OCT20Q23(object sender, EventArgs e)
        {
            question23.IsVisible = false;
            question24.IsVisible = true;
            DisplayAlert("Information", "Incorrect answer !", "Ok");
        ...
        private void OCT25Q23(object sender, EventArgs e)
        {
            question23.IsVisible = false;
            question24.IsVisible = true;
            score = score + 1;
        ...
        private void OCT30Q23(object sender, EventArgs e)
        {
            question23.IsVisible = false;
            question24.IsVisible = true;
            DisplayAlert("Information", "Incorrect answer !", "Ok");
        ...
        #endregion
        #region Question 24
        private void MRNIATOQ24(object sender, EventArgs e)
        {
            question24.IsVisible = false;
            question25.IsVisible = true;
            score = score + 1;
            DisplayAlert("Information", "Good answer !", "Ok");
            scorelabelingame.Text = "Here is your score : " + score.ToString() + " /25";
        }
        private void LAPYQ24(object sender, EventArgs e)
        {
            question24.IsVisible = false;
            question25.IsVisible = true;
            DisplayAlert("Information", "Incorrect answer !", "Ok");
        ...
        private void DEFAULTQ24(object sender, EventArgs e)
        {
            question24.IsVisible = false;
            question25.IsVisible = true;
            DisplayAlert("Information", "Incorrect answer !", "Ok");
        ...
        private void SONYQ24(object sender, EventArgs e)
        {
            question24.IsVisible = false;
            question25.IsVisible = true;
            DisplayAlert("Information", "Incorrect answer !", "Ok");
        ...
        #endregion
        #region Question 25
        private void Fire30Q25(object sender, EventArgs e)
        {
            question25.IsVisible = false;
            ...
            scorelabel.Text = "Here is your score : " + score.ToString() + " /25";
            if (score == 25)
            {
            ...
            {
                DisplayAlert("Information", score.ToString() + "/25\n Nice try but you can do a better score !", "Ok");
            }
        ...
        private void MathieuQ25(object sender, EventArgs e)
        {
            question25.IsVisible = false;
            scoreframe.IsVisible = true;
            scorelabelingame.IsVisible = false;
        ...
        private void SpecterQ25(object sender, EventArgs e)
        {
            question25.IsVisible = false;
            scoreframe.IsVisible = true;
            scorelabelingame.IsVisible = false;
        ...
        private void AlAzifQ25(object sender, EventArgs e)
        {
            question25.IsVisible = false;
            scoreframe.IsVisible = true;
            scorelabelingame.IsVisible = false;
